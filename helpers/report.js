...
export const report = {
  ...
  setAges(mediaReport) {
    ...
    ages.push({
      name: "< 22 yr",
      maleValue: mediaReport.Percent_unique_visitors_male_less_than22__c,
      femaleValue: mediaReport.Percent_unique_visitors_female_less_than__c
    });
    ages.push({
      name: "22 - 25 yr",
      maleValue: mediaReport.Percent_unique_visitors_male_22_to_25yr__c,
      femaleValue: mediaReport.Percent_unique_visitors_female_22_to_25y__c
    });
    ages.push({
      name: "26 - 30 yr",
      maleValue: mediaReport.Percent_unique_visitors_male_26_to_30yr__c,
      femaleValue: mediaReport.Percent_unique_visitors_female_26_to_30y__c
    });
    ages.push({
      name: "31 - 35 yr",
      maleValue: mediaReport.Percent_unique_visitors_male_31_to_35yr__c,
      femaleValue: mediaReport.Percent_unique_visitors_female_31_to_35y__c
    });
    ages.push({
      name: "36 - 40 yr",
      maleValue: mediaReport.Percent_unique_visitors_male_36_to_40yr__c,
      femaleValue: mediaReport.Percent_unique_visitors_female_36_to_40y__c
    });
    ages.push({
      name: "41 - 45 yr",
      maleValue: mediaReport.Percent_unique_visitors_male_41_to_45yr__c,
      femaleValue: mediaReport.Percent_unique_visitors_female_41_to_45y__c
    });
    ages.push({
      name: "46 - 50 yr",
      maleValue: mediaReport.Percent_unique_visitors_male_46_to_50yr__c,
      femaleValue: mediaReport.Percent_unique_visitors_female_46_to_50y__c
    });
    ages.push({
      name: "51 - 55 yr",
      maleValue: mediaReport.Percent_unique_visitors_male_51_to_55yr__c,
      femaleValue: mediaReport.Percent_unique_visitors_female_51_to_55y__c
    });
    ages.push({
      name: "56 - 60 yr",
      maleValue: mediaReport.Percent_unique_visitors_male_56_to_60yr__c,
      femaleValue: mediaReport.Percent_unique_visitors_female_56_to_60y__c
    });
    ages.push({
      name: "> 60 yr",
      maleValue: mediaReport.Percent_unique_visitors_male_more_than60__c,
      femaleValue: mediaReport.Percent_unique_visitors_female_more_than__c
    });
  ...
  setTopGridReachesAndEyeBalls(topGridReachesAndEyeBalls) {
    ...
    if (topGridReachesAndEyeBalls.length > 0) {
      topGridReachesAndEyeBalls.forEach(topGridReachAndEyeBall => {
        ...
        topGridReachesAndEyeBallsChartData.labels.push(
          monthYear.format("MMM YYYY")
        );
        topGridReachesAndEyeBallsChartData.datasets[0].data.push(
          topGridReachAndEyeBall.Reach__c
        );
        topGridReachesAndEyeBallsChartData.datasets[1].data.push(
          topGridReachAndEyeBall.Total_eyeballs__c
        );
      });
    }
  ...
  createPieChart(chartKey, chartData, chartColors) {
    am4core.addLicense("ch-custom-attribution");
    // Create chart instance
    const chart = am4core.create(chartKey, am4charts.PieChart);
    ...
    const colors = chartData.map(data => am4core.color(data.color));
    ...
    // pieSeries.labels.template.tooltipText = "foo";
    // pieSeries.slices.template.tooltipText = "{category}: {value}";
    pieSeries.labels.template.adapter.add("text", (text, target) =>
      target.dataItem.values.value.percent > 0 ? "{value.value}%" : ""
    );
    pieSeries.labels.template.fontSize = 10;
    pieSeries.labels.template.fontFamily = "Kanit";
